        ...
        <div className="container mx-auto mb-8">
            <main>
                <section className="container">
                    <div className="border-b-2 border-gray-300 mb-6 mt-6">
                    ...
                    <div className="container__nav">
                        <small className="block mb-2">By clicking 'Accept' you are agreeing to our terms and conditions.</small>
                        <a href="#" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Accept</a>
                    </div>
                </section>
            </main>
        </div>
